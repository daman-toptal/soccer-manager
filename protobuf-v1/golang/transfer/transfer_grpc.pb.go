...
type TransferServiceClient interface {
	...
	Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Transfer, error)
}
...
func (c *transferServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Transfer, error) {
	out := new(Transfer)
	err := c.cc.Invoke(ctx, "/protobuf.transfer.TransferService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Transfer, error) {
	out := new(Transfer)
	err := c.cc.Invoke(ctx, "/protobuf.transfer.TransferService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransferServiceServer interface {
	...
	Create(context.Context, *CreateRequest) (*Transfer, error)
...
func (UnimplementedTransferServiceServer) Create(context.Context, *CreateRequest) (*Transfer, error) {
...
func _TransferService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.transfer.TransferService/Get",
	}
...
func _TransferService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.transfer.TransferService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TransferService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protobuf.transfer.TransferService",
